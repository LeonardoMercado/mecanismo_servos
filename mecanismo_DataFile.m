...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(2).translation = [4.9866704733734989e-19 -2.0761186409091339e-34 0.0069999999999999889];  % m
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(3).translation = [-1.7763568394002505e-17 3.552713678800501e-17 0];  % m
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(4).translation = [0.23999999999999994 8.3266726846886741e-17 0.0031749999999999851];  % m
...
smiData.RevoluteJoint(1).Rz.Pos = -63.223881949537741;  % deg
smiData.RevoluteJoint(1).ID = '[eslabon_1:1:-:base:1]';

smiData.RevoluteJoint(2).Rz.Pos = 129.01285401517652;  % deg
